defmodule FirstprojectWeb.Audio do
  ...
  def mount(_params, _session, socket) do
   ...
   def handle_event("go_to_bedtime", _params, socket) do
    {:noreply, assign(socket, :live_action, :bedtime)}
  end
  ...
  def render(assigns) do
   ...
   <div class="relative h-screen bg-[#061131] overflow-hidden">
      ...
      <div class="absolute inset-0 z-0 opacity-100" 
           style={if @live_action == :bedtime, do: "background-image: url('https://s3-alpha-sig.figma.com/img/94a4/02f7/f4438ed4c6602d708526cdb2a1658bc9?Expires=1745193600&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=lKghdhx6ggjz8cLVzT0iX9vy0oQZGQWswXkeyJOcFtKZlI9jbBVbvhhC1-dil0B9mgIY4z9Ixr0eZsSJ6cb0Pq-Vp-GQpyM-6slHAUMKztbUSeWJKkGrDS26meLTHkpKmoiSgFTuN6GELKbb2z3p~Szn~LSvj8k4mYj~rX-2~pMHpQHh-78L-iULFaUmdb~Oj1YvYk2a~Nbvm6vkHEtHam~TkVU5M94PDNErCn1IFrIE2XSiMjeSkVCJTqq0~e-MqJlGcNPCKoeS0ogk~xLDJLHmi09nDZu2iau4TcdChQjwmIn5Nv6GfhSPRAhzrPBzzbgRlo1jMCWf-oFrUiragw__');", else: "background-image: url('https://s3-alpha-sig.figma.com/img/9b9c/fb96/10010623cb07ef3170592f27dcf6bcc1?Expires=1745193600&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=VKu8toPVdj-e86sPRNLUxRqhxA1sViuDtocUYPXV86cwQzGVZ9w7Sx5IuseA8klpYlWtjc9~tlZ3TrA7Cbs2wRlIK2ix288lR6Q4lijWQSBhAhV1uzm4LNcZKCrq0mrVtoziIv1yUXhu6TIrueuyh6qdda~4qrP8aX05u8w5OZJs8hv098tYQOMoZxnLSJmBCVknGkdSl4K~~t46zOURZfOKCI37EpbG4FPLIADJSZzBpmEdRvg-dKanUycDAPQyG8QgUCQnfx4u61-o6ZjoomZfgIcJtc5TQ8q~jcldwxHIb8NoOsGZC5tI4kXe1N5-VMVE2lCgREwztFQm3KrCnQ__');"}>
      </div>  

      <!-- Main Content -->
      <div class="relative flex flex-col h-screen overflow-hidden">
        <!-- Button Section -->
        <div class="w-full p-4 flex items-center relative">
          <div class="relative">
            ...
            <div class="w-8 h-8 font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-black cursor-pointer">
...
<% end %>
        ...
        <div class="w-1/2 p-8 pl-7 flex  justify-center">
          ...
          <!-- Right Side -->
            <div class="relative z-10 flex overflow-y-auto items-center justify-center w-1/2">
              ...
              <div class="flex flex-wrap gap-4">
                <div class="flex flex-col  bg-white w-[234px] min-w-[234px]">
                  <div class="relative w-[234px] min-w-[234px]">
                    ...
                    <span class="absolute bottom-0 font-karma text-2xl left-0 right-0 text-center font-medium">
                      <span class="text-[#9B7925]">LECTURES BY</span> <br><span class="text-black">MUFTI MENK</span>
                    </span>
                  </div>
                </div>
                ...
                <div class="flex flex-col bg-white w-[234px] min-w-[234px]">
                  <div class="relative w-[234px] min-w-[234px]">
                    <img src="https://s3-alpha-sig.figma.com/img/9f3f/c207/087e40ada70f3e0bed0f93ad0ae7f4b0?Expires=1743984000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=aK4O~aBtozxpk8I5m5iPXYthTCdawGcvenPIYS1iP6fO1uKlM8tqabstP4TN78h6XePk2ncPftTsN-ntpzxAU-bIO-DDulW7El-wTM-W69VA3722u2StIhtH1FpeS5l62uZf2zIEhC6xzKaCSLpOJCAO1pgmAHILsYYPsmPJ3tG-orH96MVMcVsTiKKqZAMA0zjEUfb6ocE9eDO5lAfxCDHo~5U5v2pv9jJ2IR1PKCfzU-WYQwNMjBFLPh3aYDHfDcJczSFYzpn7ne2y3y0RCOsCRrLis5BjFe3SR3qS8g1D1ndSupheSadsSf2qnwspPvjifkw-AqkjD58htPO6vg__" class="w-[234px] min-w-[234px]" />
                    <span class="absolute bottom-0 font-karma text-2xl left-0 right-0 text-center font-medium">
                      <span class="text-[#9B7925]">STORIES OF</span> <br><span class="text-black">PROPHETS</span>
                    </span>
                  </div>
                </div>
                 <div class="flex flex-col bg-white w-[234px] min-w-[234px]">
            ...
            <div class="flex flex-col bg-white w-[234px] min-w-[234px]">
              <div class="relative w-[234px] min-w-[234px]">
                <img src="https://s3-alpha-sig.figma.com/img/9f3f/c207/087e40ada70f3e0bed0f93ad0ae7f4b0?Expires=1743984000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=aK4O~aBtozxpk8I5m5iPXYthTCdawGcvenPIYS1iP6fO1uKlM8tqabstP4TN78h6XePk2ncPftTsN-ntpzxAU-bIO-DDulW7El-wTM-W69VA3722u2StIhtH1FpeS5l62uZf2zIEhC6xzKaCSLpOJCAO1pgmAHILsYYPsmPJ3tG-orH96MVMcVsTiKKqZAMA0zjEUfb6ocE9eDO5lAfxCDHo~5U5v2pv9jJ2IR1PKCfzU-WYQwNMjBFLPh3aYDHfDcJczSFYzpn7ne2y3y0RCOsCRrLis5BjFe3SR3qS8g1D1ndSupheSadsSf2qnwspPvjifkw-AqkjD58htPO6vg__"
                  class="w-[234px] min-w-[234px]" />
                <span class="absolute bottom-0 font-karma text-2xl left-0 right-0 text-center font-medium">
                  <span class="text-[#9B7925]">DAILY</span> <br><span class="text-black">ADKHARS</span>
                </span>
              </div>
            </div>
            ...
            <div class="flex flex-col bg-white w-[234px] min-w-[234px]">
              <div class="relative w-[234px] min-w-[234px]">
                <img src="https://s3-alpha-sig.figma.com/img/9f3f/c207/087e40ada70f3e0bed0f93ad0ae7f4b0?Expires=1743984000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=aK4O~aBtozxpk8I5m5iPXYthTCdawGcvenPIYS1iP6fO1uKlM8tqabstP4TN78h6XePk2ncPftTsN-ntpzxAU-bIO-DDulW7El-wTM-W69VA3722u2StIhtH1FpeS5l62uZf2zIEhC6xzKaCSLpOJCAO1pgmAHILsYYPsmPJ3tG-orH96MVMcVsTiKKqZAMA0zjEUfb6ocE9eDO5lAfxCDHo~5U5v2pv9jJ2IR1PKCfzU-WYQwNMjBFLPh3aYDHfDcJczSFYzpn7ne2y3y0RCOsCRrLis5BjFe3SR3qS8g1D1ndSupheSadsSf2qnwspPvjifkw-AqkjD58htPO6vg__"
                  class="w-[234px] min-w-[234px]" />
                <span class="absolute bottom-1 font-karma text-2xl left-0 right-0 text-center font-medium">
                  <span class="text-[#9B7925]">SEERAH</span> <br><span class="text-black">LECTURES</span>
                </span>
              </div>
            </div>
